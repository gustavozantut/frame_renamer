...
def main():
    ...
    while True:
        ...
        try:
            ...
            for filename in sorted([os.path.join(frames_dir, file) for file in os.listdir(frames_dir) if (os.path.isfile(os.path.join(frames_dir, file))) & (filename not in renamed_files)]):
